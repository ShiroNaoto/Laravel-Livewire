                            ...
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <ul class="nav nav-pills ml-auto">
                                        <li class="nav-item">
                                            <a class="nav-link {{ $activeTab === 'pending' ? 'active' : '' }}" wire:click = "resetTable" href="#" wire:click.prevent="switchTab('pending')">Ticket Pending | Process</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link {{ $activeTab === 'process' ? 'active' : '' }}" wire:click = "resetTable" href="#" wire:click.prevent="switchTab('process')">Request Resolved</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            <div class="tab-content p-0">
                                <div class="chart tab-pane {{ $activeTab === 'pending' ? 'active' : '' }}" id="pending">
                                    <div class="card-body">
                                ...
                                <div class="chart tab-pane {{ $activeTab === 'process' ? 'active' : '' }}" id="process">
                                    <div class="card-body">
                                        <div class="mb-4 input-group">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text"><i class="fas fa-search fa-fw"></i></span>
